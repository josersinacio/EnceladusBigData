...
## Estratificação por tipo de queimadura

```{r, echo = FALSE}
contagem_por_tipo <- read.csv(paste0(diretorio, contagem_por_tipo, sep = "/"))
...
## Densidade municipal no período
...
kable(
    paste0(diretorio, municipios_com_casos, sep = "/"),
...
kable(
    paste0(diretorio, municipios_sem_casos, sep = "/"),
