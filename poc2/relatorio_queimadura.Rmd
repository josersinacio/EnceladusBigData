---
title: "Relatório de Queimaduras"
output: pdf_document
params: 
    relatorio: "relatorio_queimaduras_sim.csv"
    output_directory: ""
    dt_inicio: ""
    dt_fim: ""
    uf: ""
...
``` {r, echo = FALSE}
library(knitr)
dataset <- read.csv(file.path(params$output_directory, params$relatorio))
kable(dataset, caption = "Densidade Municipal por Período")
```

###  Para fins de filtragem os seguintes códigos CID foram considerados:
